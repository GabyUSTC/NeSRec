...
def parse_args():
    parser = argparse.ArgumentParser(description="NeSRecF")
    ...
    parser.add_argument('--is_rm', type=int, default=0, help='cut turst edge?')
    parser.add_argument('--prefer_thres', type=float, default=1.0, help='individual interest threshold t')
    parser.add_argument('--num_neigh_thres', type=int, default=0, help='')
    parser.add_argument('--group_size', type=int, default=50, help='#users in a group')
    ...
    parser.add_argument('--beta', type=float, default=1.0, help='neighbor interference strength coefficient')
    parser.add_argument('--power', type=float, default=0.5, help='normalization factor')

    parser.add_argument('--penalty_weight', type=float, default=0.0, help='tradeoff coefficient gamma')
